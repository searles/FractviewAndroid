...
public class IntegerDialogFragment extends DialogFragment {
    ...
    public static IntegerDialogFragment newInstance(String title, String id, int value) {
        Bundle b = new Bundle();
    ...
    private boolean onOkClick(Button okButton, EditText editor, TextView msgTextView) {
        try {
            ...
            fractalFragment.provider().set(new ParameterKey(id, ParameterType.Int), value);
