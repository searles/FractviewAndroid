...
public class PresetFractals {
	...
	public static final Preset[] PRESETS = new Preset[] {
			...
			new Preset("Two Fold / Magnet 1", "TwoFold.fv", "TwoFoldMagnet1.png", new Scale(3, 0, 0, 3, 1, 0), new Fractal.Parameters()
			...
			new Preset("Two Fold / Magnet 2", "TwoFold.fv", "TwoFoldMagnet2.png", new Scale(2, 0, 0, 2, 1, 0), new Fractal.Parameters()
			...
			new Preset("Root Finding", "RootFinding.fv", "RootFinding.png", new Scale(2, 0, 0, 2, 0, -1.5), new Fractal.Parameters()),

			new Preset("Newton", "Newton.fv", "Newton.png", Scale.createScaled(2), new Fractal.Parameters()),

			new Preset("Newton / SinH", "Newton.fv", "NewtonSinH.png", Scale.createScaled(5), new Fractal.Parameters()
			...
			new Preset("Lyapunov", "Lyapunov.fv", "Lyapunov.png", new Scale(0.45, 0, 0, -0.3, 3.05, 3.7), new Fractal.Parameters()),
